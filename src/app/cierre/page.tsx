        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-slate-500">Registrar nuevo contrato (Venta o Alquiler)</p>
                </div>
            </div>
            
            <Link href="/cierre/historial">
                <button className="btn bg-slate-800 text-white hover:bg-slate-900 shadow-lg border-none gap-2">
                    <FaHistory /> Ver Historial de Cierres
                </button>
            </Link>
        </div>
